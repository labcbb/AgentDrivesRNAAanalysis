...
Top-level routing uses **LangGraph** by default (`sRNAgent/agent/lc_graph.py`); function/skill layers and `PlanOrchestrator` stay as-is. See `sRNAgent/agent/LANGGRAPH.md`. Set `SRNAGENT_USE_LANGGRAPH=legacy` to disable.
