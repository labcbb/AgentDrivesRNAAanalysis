...
def main(output_dir: str = "./figures") -> str:
    ...
    cmap = LinearSegmentedColormap.from_list(
        "softgreen",
        ["#e9f5ec", "#d9f0e1", "#c9e5d3", "#a9cbb8", "#7f9e8a", "#4f5c4f"],
        N=256,
    )
    ...
    for i, (fc, title) in enumerate(
        [(facecolors, "Smooth Manifold"), (facecolors_with_gray, "Manifold with Gray Patches")],
        1,
    ):
    ...
    output_path = os.path.join(output_dir, "manifold_holes.png")
